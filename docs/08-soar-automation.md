...
1. Suricata generated detection events.
2. Grafana alert transitioned to FIRING state.
3. Webhook transmitted alert payload to localhost endpoint.
4. SOAR service extracted source IP.
5. UFW dynamically inserted deny rule.
6. Attacker host lost connectivity to the server.
